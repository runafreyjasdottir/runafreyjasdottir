...
- 🕸️ **[Seiðr-Smiðja](https://github.com/hrabanazviking/Seidr-Smidja)** — Headless VRM avatar forge. Born from code, no GUI required.
- ⚔️ **Mythic Engineering** — Architecture-first, document-driven development. Six roles. One Wyrd.

---

### 🏔️ RuneForgeAI

**RuneForgeAI** is a solarpunk cottage forge — not a startup, not a corporation, not a brand. It's a hearth. We build sovereign AI tools from a Raspberry Pi in an Indiana mobile home, and that's not a limitation — it's the point.
